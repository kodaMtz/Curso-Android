...
fun ReplyHomeScreen(
    ...
    // CAMBIO: agregamos contentType como parámetro
    ...
    // CAMBIO: quitamos la condición isShowingHomepage del drawer
...
private fun ReplyAppContent(
    ...
    Row(modifier = modifier) {
        ...
        Column(
            ...
            // CAMBIO: if/else para mostrar lista+detalle o solo lista
