...
fun ReplyDetailsScreen(
    ...
    // CAMBIO: parámetro isFullScreen para diferenciar uso independiente vs panel
    ...
    val detailScreenContentDescription = stringResource(R.string.details_screen)
    LazyColumn(
        modifier = modifier
            .fillMaxSize()
            .background(color = MaterialTheme.colorScheme.inverseOnSurface)
            .padding(top = dimensionResource(R.dimen.detail_card_list_padding_top))
            .testTag(detailScreenContentDescription)
    ) {
        item {
            // CAMBIO: solo mostrar TopBar cuando es pantalla completa
            if (isFullScreen) {
            ...
            ReplyEmailDetailsCard(
                ...
                // CAMBIO: padding diferente según si es pantalla completa o panel
...
private fun ReplyEmailDetailsCard(
    ...
    Card(
        ...
        Column(
            ...
            // CAMBIO: en pantalla completa mostrar Spacer, si no mostrar asunto
            if (isFullScreen) {
